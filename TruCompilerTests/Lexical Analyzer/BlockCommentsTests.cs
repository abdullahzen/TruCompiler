...
namespace TruCompilerTests.Lexical_Analyzer
{
    ...
    public class BlockCommentsTests
    {
        ...
        public void TestSingleLineBlockComment()
        {
            ...
            Assert.AreEqual(Lexeme.opencmt, tokens[0].Lexeme);
            Assert.AreEqual(Lexeme.blockcmt, tokens[1].Lexeme);
            Assert.AreEqual(Lexeme.closecmt, tokens[2].Lexeme);
            ...
            Assert.AreEqual("/* this is a regular single line block comment */", tokens[1].Value);
        ...
        public void TestSingleBlockCommentAfterCodeUsingTokenizeFunction()
        {
            ...
            Assert.AreEqual(Lexeme.opencmt, tokens[2].Lexeme);
            Assert.AreEqual(Lexeme.blockcmt, tokens[3].Lexeme);
            Assert.AreEqual(Lexeme.closecmt, tokens[4].Lexeme);
            Assert.AreEqual(1, tokens[0].Line);
            Assert.AreEqual(1, tokens[1].Line);
            Assert.AreEqual(1, tokens[2].Line);
            ...
            Assert.AreEqual("/*", tokens[2].Value);
            Assert.IsTrue("/* this is also a single line block comment */".Equals(tokens[3].Value));
        ...
        public void TestSingleBlockCommentBeforeCodeUsingTokenizeFunctionWithTabsInMiddleAndEnd()
        {
            ...
            Assert.AreEqual(Lexeme.eq, tokens[4].Lexeme);
            Assert.AreEqual(1, tokens[0].Line);
            Assert.AreEqual(1, tokens[1].Line);
            Assert.AreEqual(1, tokens[2].Line);
            Assert.AreEqual(1, tokens[3].Line);
            ...
            Assert.IsTrue(tokens[4].IsValid);
            Assert.AreEqual("/*", tokens[0].Value);
            Assert.AreEqual("/*this\tis a\tcomment\tinline*/", tokens[1].Value);
            Assert.AreEqual("*/", tokens[2].Value);
        ...
        public void TestSingleBlockCommentSymbolInMiddleOfWordThatHasCodeAndCommentUsingTokenizeFunction()
        {
            ...
            Assert.AreEqual(Lexeme.keyword, tokens[0].Lexeme);
            Assert.AreEqual(Lexeme.opencmt, tokens[1].Lexeme);
            Assert.AreEqual(Lexeme.blockcmt, tokens[2].Lexeme);
            Assert.AreEqual(Lexeme.closecmt, tokens[3].Lexeme);
            Assert.AreEqual(1, tokens[0].Line);
            Assert.AreEqual(1, tokens[1].Line);
            Assert.AreEqual(1, tokens[2].Line);
            Assert.AreEqual(1, tokens[3].Line);
            ...
            Assert.AreEqual("if", tokens[0].Value);
            Assert.AreEqual("/*", tokens[1].Value);
            Assert.AreEqual("/*comment\t = \t*/", tokens[2].Value);
        ...
        public void TestSingleBlockCommentBetweenCodeAndCommentWithASapceInCommentWithMultipleCommentSymbolsUsingTokenizeFunction()
        {
            ...
            Assert.AreEqual(Lexeme.closecmt, tokens[3].Lexeme);
            Assert.AreEqual(Lexeme.eq, tokens[4].Lexeme);
            Assert.AreEqual(Lexeme.keyword, tokens[5].Lexeme);
            Assert.AreEqual(Lexeme.keyword, tokens[6].Lexeme);
            ...
            Assert.AreEqual("if", tokens[0].Value);
            Assert.AreEqual("/*", tokens[1].Value);
            Assert.AreEqual("/* comm/*ent\t = \t */", tokens[2].Value);
            Assert.AreEqual("*/", tokens[3].Value);
            Assert.AreEqual("=", tokens[4].Value);
            Assert.AreEqual("while", tokens[5].Value);
            Assert.AreEqual("do", tokens[6].Value);
        }
        ...
        public void TestMultiLineBlockComment()
        {
            ...
            Assert.AreEqual(1, tokens[0].Line);
            Assert.AreEqual(1, tokens[1].Line);
            Assert.AreEqual(4, tokens[2].Line);
            Assert.IsTrue(tokens[0].IsValid);
            Assert.IsTrue(tokens[1].IsValid);
            Assert.IsTrue(tokens[2].IsValid);
            Assert.AreEqual("/*", tokens[0].Value);
        ...
        public void TestMultiBlockCommentAfterCodeUsingTokenizeFunction()
        {
            ...
            Assert.AreEqual("=", tokens[1].Value);
            Assert.AreEqual("/*", tokens[2].Value);
            Assert.IsTrue("/*thi\\ns is also a multi line block comment*/".Equals(tokens[3].Value));
            Assert.AreEqual("*/", tokens[4].Value);
        }
