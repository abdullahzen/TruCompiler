...
namespace TruCompilerTests.Lexical_Analyzer
{
    ...
    public class OperandsTests
    {
        ...
        public void TestKeywordEq()
        {
            ...
            Assert.AreEqual(Lexeme.eq, tokens[0].Lexeme);
        ...
        public void TestKeywordEqEq()
        {
            tokens = LexicalAnalyzer.Tokenize("==");
            Assert.AreEqual(1, tokens.Count);
            Assert.AreEqual(Lexeme.eqeq, tokens[0].Lexeme);
            Assert.AreEqual("==", tokens[0].Value);
            Assert.AreEqual(1, tokens[0].Line);
            Assert.IsTrue(tokens[0].IsValid);
        }
        ...
        public void TestKeywordLt()
        {
            tokens = LexicalAnalyzer.Tokenize("<");
            Assert.AreEqual(1, tokens.Count);
            Assert.AreEqual(Lexeme.lt, tokens[0].Lexeme);
            Assert.AreEqual("<", tokens[0].Value);
            Assert.AreEqual(1, tokens[0].Line);
            Assert.IsTrue(tokens[0].IsValid);
        }
        ...
        public void TestKeywordGt()
        {
            tokens = LexicalAnalyzer.Tokenize(">");
            Assert.AreEqual(1, tokens.Count);
            Assert.AreEqual(Lexeme.gt, tokens[0].Lexeme);
            Assert.AreEqual(">", tokens[0].Value);
            Assert.AreEqual(1, tokens[0].Line);
            Assert.IsTrue(tokens[0].IsValid);
        }
        ...
        public void TestKeywordLeq()
        {
            tokens = LexicalAnalyzer.Tokenize("<=");
            Assert.AreEqual(1, tokens.Count);
            Assert.AreEqual(Lexeme.leq, tokens[0].Lexeme);
            Assert.AreEqual("<=", tokens[0].Value);
            Assert.AreEqual(1, tokens[0].Line);
            Assert.IsTrue(tokens[0].IsValid);
        }
        ...
        public void TestKeywordGeq()
        {
            tokens = LexicalAnalyzer.Tokenize(">=");
            Assert.AreEqual(1, tokens.Count);
            Assert.AreEqual(Lexeme.geq, tokens[0].Lexeme);
            Assert.AreEqual(">=", tokens[0].Value);
            Assert.AreEqual(1, tokens[0].Line);
            Assert.IsTrue(tokens[0].IsValid);
        }
        ...
        public void TestKeywordPlus()
        {
            tokens = LexicalAnalyzer.Tokenize("+");
            Assert.AreEqual(1, tokens.Count);
            Assert.AreEqual(Lexeme.plus, tokens[0].Lexeme);
            Assert.AreEqual("+", tokens[0].Value);
            Assert.AreEqual(1, tokens[0].Line);
            Assert.IsTrue(tokens[0].IsValid);
        }
        ...
        public void TestKeywordMinus()
        {
            tokens = LexicalAnalyzer.Tokenize("-");
            Assert.AreEqual(1, tokens.Count);
            Assert.AreEqual(Lexeme.minus, tokens[0].Lexeme);
            Assert.AreEqual("-", tokens[0].Value);
            Assert.AreEqual(1, tokens[0].Line);
            Assert.IsTrue(tokens[0].IsValid);
        }
        ...
        public void TestKeywordMult()
        {
            tokens = LexicalAnalyzer.Tokenize("*");
            Assert.AreEqual(1, tokens.Count);
            Assert.AreEqual(Lexeme.mult, tokens[0].Lexeme);
            Assert.AreEqual("*", tokens[0].Value);
            Assert.AreEqual(1, tokens[0].Line);
            Assert.IsTrue(tokens[0].IsValid);
        }
        ...
        public void TestKeywordDiv()
        {
            tokens = LexicalAnalyzer.Tokenize("/");
            Assert.AreEqual(1, tokens.Count);
            Assert.AreEqual(Lexeme.div, tokens[0].Lexeme);
            Assert.AreEqual("/", tokens[0].Value);
            Assert.AreEqual(1, tokens[0].Line);
            Assert.IsTrue(tokens[0].IsValid);
        }
        ...
        public void TestKeywordOpenPar()
        {
            tokens = LexicalAnalyzer.Tokenize("(");
            Assert.AreEqual(1, tokens.Count);
            Assert.AreEqual(Lexeme.openpar, tokens[0].Lexeme);
            Assert.AreEqual("(", tokens[0].Value);
            Assert.AreEqual(1, tokens[0].Line);
            Assert.IsTrue(tokens[0].IsValid);
        }
        ...
        public void TestKeywordClosePar()
        {
            tokens = LexicalAnalyzer.Tokenize(")");
            Assert.AreEqual(1, tokens.Count);
            Assert.AreEqual(Lexeme.closepar, tokens[0].Lexeme);
            Assert.AreEqual(")", tokens[0].Value);
            Assert.AreEqual(1, tokens[0].Line);
            Assert.IsTrue(tokens[0].IsValid);
        }
        ...
        public void TestKeywordOpencbr()
        {
            tokens = LexicalAnalyzer.Tokenize("{");
            Assert.AreEqual(1, tokens.Count);
            Assert.AreEqual(Lexeme.opencbr, tokens[0].Lexeme);
            Assert.AreEqual("{", tokens[0].Value);
            Assert.AreEqual(1, tokens[0].Line);
            Assert.IsTrue(tokens[0].IsValid);
        }
        ...
        public void TestKeywordClosecbr()
        {
            tokens = LexicalAnalyzer.Tokenize("}");
            Assert.AreEqual(1, tokens.Count);
            Assert.AreEqual(Lexeme.closecbr, tokens[0].Lexeme);
            Assert.AreEqual("}", tokens[0].Value);
            Assert.AreEqual(1, tokens[0].Line);
            Assert.IsTrue(tokens[0].IsValid);
        }
        ...
        public void TestKeywordOpensqbr()
        {
            tokens = LexicalAnalyzer.Tokenize("[");
            Assert.AreEqual(1, tokens.Count);
            Assert.AreEqual(Lexeme.opensqbr, tokens[0].Lexeme);
            Assert.AreEqual("[", tokens[0].Value);
            Assert.AreEqual(1, tokens[0].Line);
            Assert.IsTrue(tokens[0].IsValid);
        }
        ...
        public void TestKeywordClosesqbr()
        {
            tokens = LexicalAnalyzer.Tokenize("]");
            Assert.AreEqual(1, tokens.Count);
            Assert.AreEqual(Lexeme.closesqbr, tokens[0].Lexeme);
            Assert.AreEqual("]", tokens[0].Value);
            Assert.AreEqual(1, tokens[0].Line);
            Assert.IsTrue(tokens[0].IsValid);
        }
        ...
        public void TestKeywordClosecmt()
        {
            tokens = LexicalAnalyzer.Tokenize("*/");
            Assert.AreEqual(1, tokens.Count);
            Assert.AreEqual(Lexeme.closecmt, tokens[0].Lexeme);
            Assert.AreEqual("*/", tokens[0].Value);
            Assert.AreEqual(1, tokens[0].Line);
            Assert.IsTrue(tokens[0].IsValid);
        }
