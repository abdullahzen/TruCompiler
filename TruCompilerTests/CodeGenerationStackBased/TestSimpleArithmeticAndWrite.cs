...
namespace TruCompilerTests.CodeGenerationStackBased
{
    ...
    public class TestSimpleArithmeticAndWrite
    {
        ...
        public void TestInitialize()
        {
            ...
            InputFiles = new string[1]; InputFiles[0] = "..\\..\\..\\Input\\Test 5\\polynomial.src";
        ...
        {
            FileWriter = new StubbedFileWriter();
            InputFiles = new string[1]; InputFiles[0] = "..\\..\\..\\Input\\Test 5\\polynomial2.src";
        ...
        {
            FileWriter = new StubbedFileWriter();
            InputFiles = new string[1]; InputFiles[0] = "..\\..\\..\\Input\\Test 5\\polynomial3.src";
